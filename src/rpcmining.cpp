...
//    if (vNodes.empty())
//        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Agena Core is not connected!");

//    if (IsInitialBlockDownload())
//        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Agena Core is downloading blocks...");

//    if (!masternodeSync.IsSynced())
//        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Agena Core is syncing with network...");
