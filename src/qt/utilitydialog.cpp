    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Agena Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Agena Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  agena-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Agena in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AGN, 0.1 AGN, 1 AGN and 10 AGN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://agenacoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://agenacoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Agena Core is shutting down...") + "<br /><br />" +
