    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Agena Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Agena address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and agena: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Agena Core"), this);
    aboutAction->setStatusTip(tr("Show information about Agena Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Agena Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Agena addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Agena addresses"));
    ...
    openAction->setStatusTip(tr("Open a agena: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Agena Core help message to get a list with possible Agena Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Agena Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Agena network", "", count));
}
...
{
    QString strTitle = tr("Agena Core"); // default title
