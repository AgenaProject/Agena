    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AGN-light"), QVariant("light"));
    ui->theme->addItem(QString("AGN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AGN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AGN-traditional"), QVariant("trad"));
