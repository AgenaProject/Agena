...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AgenaNetwork") type = AgenaNetwork;
    if(strType == "AgenaNetworkVariable") type = AgenaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AgenaNetwork) s = "AgenaNetwork";
    if(type == AgenaNetworkVariable) s = "AgenaNetworkVariable";
