 ...
 *
 *   // network
 *   CAgenaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.agena.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAgenaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AgenaNetwork
// //   -- signature requirements : Key1(User)
// class CAgenaNetworkVariable : public CGovernanceObject
// {
// private:
