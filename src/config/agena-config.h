/* src/config/agena-config.h.  Generated from agena-config.h.in by configure.  */
/* src/config/agena-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AGENA_CONFIG_H

#define AGENA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/agenacoin/agena/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Agena Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Agena Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "agenacore"
